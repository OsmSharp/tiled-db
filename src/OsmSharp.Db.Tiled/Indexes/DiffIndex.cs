...
//{
//    /// <summary>
//    /// Represents an index matching ids to one or more sub tiles with an extra flag indicating deleted objects.
//    /// </summary>
//    public class DiffIndex : IDisposable
//    {
...
//        }
//        
//        private DiffIndex(ArrayBase<ulong> data)
//        {
//            _data = data;
...
//        /// </summary>
//        public void Add(long id, int mask, bool deleted)
//        {
//            if (mask > MaxMask) {throw new ArgumentOutOfRangeException(nameof(mask));}
//
//            if (_pointer > 0)
//            {
//                Decode(_data[_pointer - 1], out var previousId, out _, out _);
//
//                if (id < previousId)
//                {
...
//            Encode(id, mask, deleted, out var data);
//            _data[_pointer] = data;
//            _pointer++;
//
//            this.IsDirty = true;
...
//        /// </summary>
//        public bool TryGetMask(long id, out int mask, out bool deleted)
//        {
//            if (!_mapped) return Search(id, out mask, out deleted) != -1;
//            lock (this)
//            {
//                return Search(id, out mask, out deleted) != -1;
//            }
//        }
//
//        /// <summary>
...
//        /// </summary>
//        public static DiffIndex Deserialize(Stream stream, ArrayProfile profile = null)
//        {
...
//            }
//
//            return new DiffIndex(data);
//        }
//
//        private const long MaxMask = 65536 - 1;
//        private const ulong MaxId = ((ulong)1 << 47) - 1;
//        private const long IdMask = ~(MaxMask << (64 - Subtiles));
//
//        /// <summary>
//        /// Decodes an id and a mask.
//        /// </summary>
//        public static void Decode(ulong data, out long id, out int mask, out bool deleted)
//        {
...
//        /// </summary>
//        public static void Encode(long id, int mask, bool deleted, out ulong data)
//        {
//            if (mask > MaxMask) {throw new ArgumentOutOfRangeException(nameof(mask));}
//            
...
//            }
//
//            if (unsignedId > MaxId) { throw new ArgumentOutOfRangeException(nameof(id)); }
//
...
//        }
//
//        private long Search(long id, out int mask, out bool deleted)
//        {
//            var min = 0L;
//            var max = _pointer - 1;
//
//            Decode(_data[min], out var minId, out mask, out deleted);
//            if (minId == id)
//            {
//                return min;
//            }
//
//            Decode(_data[max], out var maxId, out mask, out deleted);
//            if (maxId == id)
//            {
//                return max;
//            }
...
//            {
//                var mid = (min + max) / 2;
//                Decode(_data[mid], out var midId, out mask, out deleted);
//                if (midId == id)
//                {
//                    return mid;
//                }
